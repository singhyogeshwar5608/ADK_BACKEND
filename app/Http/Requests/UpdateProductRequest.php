...
class UpdateProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'igst' => ['sometimes', 'nullable', 'numeric', 'min:0', 'max:100'],
    ...
    protected function prepareForValidation(): void
    {
        $this->merge([
            ...
            'sgst' => $this->input('sgst', $this->input('sgstRate', $this->input('sgst_rate'))),
            'cgst' => $this->input('cgst', $this->input('cgstRate', $this->input('cgst_rate'))),
            'igst' => $this->input('igst', $this->input('igstRate', $this->input('igst_rate'))),
