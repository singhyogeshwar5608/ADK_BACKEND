...
class StoreProductRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        $this->merge([
            ...
            'sgst' => $this->input('sgst', $this->input('sgstRate', $this->input('sgst_rate', 0))),
            'cgst' => $this->input('cgst', $this->input('cgstRate', $this->input('cgst_rate', 0))),
            'igst' => $this->input('igst', $this->input('igstRate', $this->input('igst_rate', 0))),
